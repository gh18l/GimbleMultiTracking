...
int Display::display_init(cv::Mat img)
{
	...
	ourShader.Shader1("/home/lgh/Documents/gimbleMulti/model/7.3.camera.vs", "/home/lgh/Documents/gimbleMulti/model/7.3.camera.fs");
...
void mouse_callback(GLFWwindow* window, double xpos, double ypos)
{
	if (flag == 1)
	{
		...
		float cameraSpeed_x = 0.5 * 0.1 * x_delta*0.2;
		float cameraSpeed_y = 0.5 * 0.1 * y_delta*0.2;

...
namespace calib {
	...
	*/
    ...
    public:
		void current_feature_thread_(cv::Mat& src, calib::Imagefeature& feature,calib::Imagefeature& current_feature,
										calib::Matchesinfo& matchesinfo,int i);
		int global2pano(cv::Mat global, cv::Mat pano);
		double match_people(cv::Mat img1, cv::Mat img2);
    private:
		/**
    ...
    public:
		...
		*/
		...
		int save_features(std::vector<calib::Imagefeature>& feature);
		int read_features(std::vector<calib::Imagefeature>& feature);
	};
